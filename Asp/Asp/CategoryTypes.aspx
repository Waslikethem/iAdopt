<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CategoryTypes.aspx.cs" Inherits="MainPage" %>
...
<body>
    <form id="form1" runat="server">
        <div style="text-align: center">
            ...
            <br />
            <br />
            <asp:Label ID="title3" runat="server" Text="Category Types Table" Font-Bold="True" Font-Size="Large"></asp:Label>
            <asp:ListView ID="ListView1" runat="server" DataKeyNames="MiscID" DataSourceID="SqlDataSource1" InsertItemPosition="LastItem">
                <AlternatingItemTemplate>
                    <tr style="background-color:#FFF8DC;">
                        ...
                        <td>
                            <asp:Label ID="MiscIDLabel" runat="server" Text='<%# Eval("MiscID") %>' />
                        </td>
                        <td>
                ...
                <EditItemTemplate>
                    <tr style="background-color:#008A8C;color: #FFFFFF;">
                        ...
                        <td>
                            <asp:Label ID="MiscIDLabel1" runat="server" Text='<%# Eval("MiscID") %>' />
                        </td>
                        <td>
                            <asp:TextBox ID="MiscNameTextBox" runat="server" Text='<%# Bind("MiscName") %>' />
                        </td>
                    </tr>
                </EditItemTemplate>
                <EmptyDataTemplate>
                            ...
                            <td runat="server">
                                <table id="itemPlaceholderContainer" runat="server" border="1" style="background-color: #FFFFFF;border-collapse: collapse;border-color: #999999;border-style:none;border-width:1px;font-family: Verdana, Arial, Helvetica, sans-serif;">
                                    <tr runat="server" style="background-color:#DCDCDC;color: #000000;">
                                        <th runat="server"></th>
                                        <th runat="server">MiscID</th>
                                        <th runat="server">MiscName</th>
                                    </tr>
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:site02ASP %>" DeleteCommand="DELETE FROM [CategoryType] WHERE [MiscID] = @original_MiscID" InsertCommand="INSERT INTO [CategoryType] ([MiscName]) VALUES (@MiscName)" OldValuesParameterFormatString="original_{0}" SelectCommand="SELECT * FROM [CategoryType]" UpdateCommand="UPDATE [CategoryType] SET [MiscName] = @MiscName WHERE [MiscID] = @original_MiscID">
                <DeleteParameters>
                    <asp:Parameter Name="original_MiscID" Type="Int32" />
                </DeleteParameters>
                <InsertParameters>
