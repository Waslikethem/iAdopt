...
export default class Publish extends React.Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            petAge:0,
            petVaccines: '',
            petRaces: [{label:'hi',value:1}, {label:'hi',value:1}, {label:'hi',value:1}, {label:'hi',value:1}],
            petRace:0,
        }
    }
    ...
    render() {
        ...
        return (
            <View style={styles.container}>
                ...
                <Button buttonStyle={{ backgroundColor: 'orange', marginTop: 30 }} title='פרסם חיה לאימוץ' onPress={this.btnPublishPet} />
            </View>
        );
    }
}
